...
import { InterestCategoryEntity } from "../../src/app/onboard/repositories/interest.category.entity";
...
export class TestDatabaseModule {
  ...
  static forConnection(): DynamicModule {
    ...
    Logger.log(
      "When error is EntityMetadataNotFound: No metadata, it means entity name needs to add in entitiesList, TestDBProviderModule",
    );
